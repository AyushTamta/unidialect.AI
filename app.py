...
def input_image_details(uploaded_file):
    if uploaded_file is not None:
        ...
        image_parts = [
            {
                "mime_type": uploaded_file.type,  # Get mime type of image
                "data": bytes_data
            }
        ]
        return image_parts
...
st.set_page_config(page_title="UniLingo.AI")

st.header("UniDialect.AI")

input_text = st.text_input("Ask anything about your invoices ", key="input")
